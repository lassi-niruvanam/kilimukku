...
export class கிளிமூக்கு {
    ...
    if (this.கிளி) {
      ...
      if (பரிந்துரைகள் === "எனது") {
        மறந்துவிடு.push(
          await this.என்_மொழிபெயர்ப்பு_பரிந்துரைகளை_கேள்ளு({
            செ: async (ப) => {
              மொழிகள்.பரிந்துரைகள் = ப.map((இ) => இ.பரிந்துரை.இலக்கு_மொழி);
              await செ_கடைசி();
            },
          }),
        );
    ...
    const செ_கடைசி = async () => {
      const சாபிகள் = [
        ...new Set([
          ...
          ...(தகவல்கள்.அங்கீகரிக்கப்பட்டவை || []).map(
            (இ) => இ[சாபி_நெடுவரிசை_அடையாளம்],
          ),
        ]),
      ];
      ...
      for (const சாபி of சாபிகள்) {
        const சாபிக்கு_அங்கீகரிக்கப்பட்டவை =
          தகவல்கள்.அங்கீகரிக்கப்பட்டவை?.filter(
            (இ) => இ[சாபி_நெடுவரிசை_அடையாளம்] === சாபி,
          ) || [];
        ...
        const சாபிக்கு_மொழிகள் = [
          ...new Set([
            ...
            ...சாபிக்கு_அங்கீகரிக்கப்பட்டவை.map(
              (இ) => இ[இலக்கு_மொழி_நெடுவரிசை_அடையாளம்],
            ),
          ]),
        ];
        ...
        for (const மொழி of சாபிக்கு_மொழிகள்) {
          ...
          const மொழிக்கு_அங்கீகரிக்கப்பட்டவை =
            சாபிக்கு_அங்கீகரிக்கப்பட்டவை.find(
              (இ) => இ[இலக்கு_மொழி_நெடுவரிசை_அடையாளம்] === மொழி,
            );
          const பிணையம்_மொழிபெயர்ப்பு = மொழிக்கு_பரிந்துரை
            ? மொழிக்கு_அங்கீகரிக்கப்பட்டவை
              ? மொழிக்கு_அங்கீகரிக்கப்பட்டவை.தேதி >
                ...
                ? மொழிக்கு_அங்கீகரிக்கப்பட்டவை[மொழிபெயர்ப்பு_நெடுவரிசை_அடையாளம்]
                : மொழிக்கு_பரிந்துரை.பரிந்துரை.மொழிபெயர்ப்பு
              : மொழிக்கு_பரிந்துரை.பரிந்துரை.மொழிபெயர்ப்பு
            : மொழிக்கு_அங்கீகரிக்கப்பட்டவை?.[மொழிபெயர்ப்பு_நெடுவரிசை_அடையாளம்];
          if (பிணையம்_மொழிபெயர்ப்பு)
            பிணையம்_மொழிபெயர்ப்புகள்[மொழி] = பிணையம்_மொழிபெயர்ப்பு;
        }
  ...
  async அங்கீகரிக்கப்பட்ட_மொழிபெயர்ப்பை_நீக்கு({
    ...
    const பொறுத்தமானது = (
      ...
      return (
        அங்கீகறிக்கப்பட்டது[சாபி_நெடுவரிசை_அடையாளம்] === சாபி &&
        அங்கீகறிக்கப்பட்டது[இலக்கு_மொழி_நெடுவரிசை_அடையாளம்] === இலக்கு_மொழி
      );
    };
