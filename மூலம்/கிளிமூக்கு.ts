...
export class கிளிமூக்கு {
  ...
  async அங்கீகரிக்கப்பட்ட_மொழிபெயர்ப்பை_நீக்கு({
    ...
    const பொறுத்தமானது = (அங்கீகறிக்கப்பட்டது: அங்கீகரிக்கப்பட்ட_உறுப்படி_வகை<மொழிபெயர்ப்பு_பரிந்துரை_உறுப்படி_வகை>): boolean => {
      return அங்கீகறிக்கப்பட்டது.சாபி === சாபி && அங்கீகறிக்கப்பட்டது.இலக்கு_மொழி === இலக்கு_மொழி
    };
    const இருக்கும்_அங்கீகறிக்கப்பட்டது = await ஒருமுறை(
      async (fSuivi: (இ: Parameters<Parameters<typeof கிளி_.அங்கீகரிக்கப்பட்ட_உறுப்படிகளை_கேள்ளு>[0]["செ"]>[0]) => void) => {
        return await கிளி_.அங்கீகரிக்கப்பட்ட_உறுப்படிகளை_கேள்ளு({
          செ: async இ => await fSuivi(இ)
        });
      },
      async (இ) => {
        return !!இ?.find(ஈ=>பொறுத்தமானது(ஈ.données)) || await attendreStabilité(பொறுமை)(இ)
      }
    );
    const அடையாளம் = இருக்கும்_அங்கீகறிக்கப்பட்டது?.find(இ=>பொறுத்தமானது(இ.données))?.id;
