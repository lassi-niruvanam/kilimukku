...
describe("கிளிமூக்கு", async () => {
  ...
  describe("முன்னேற்றம்", async () => {
    ...
    const தமிழ்_முன்னேற்றம் =
      new attente.AttendreRésultat<முன்னேற்றம்_தகவல்கள்>();
    const தமிழ்_வார்த்தை_முன்னேற்றம் =
      new attente.AttendreRésultat<முன்னேற்றம்_தகவல்கள்>();
    const செ_மறந்துவிடு: (() => Promise<void>)[] = [];
    ...
    before(async () => {
      ...
      const தமிழ்_வார்த்தை_முன்னேற்றத்தை_மறந்துவிடு =
        await என்_கிளிமூக்கு.முன்னேற்றத்தை_கேள்ளு({
          மொழி: "த",
          வகை: "வார்த்தை",
          செ: (இ) => தமிழ்_வார்த்தை_முன்னேற்றம்.mettreÀJour(இ),
        });
      செ_மறந்துவிடு.push(தமிழ்_வார்த்தை_முன்னேற்றத்தை_மறந்துவிடு);
    });
