...
import { இலக்கு_மொழி_நெடுவரிசை_அடையாளம், கிளிமூக்கு, சாபி_நெடுவரிசை_அடையாளம், பிணையம்_மொழிபெயர்ப்பு_பரிந்துரை_வகை, மூல்_உரை_நெடுவரிசை_அடையாளம், மூல்_மொழி_நெடுவரிசை_அடையாளம், மொழிபெயர்ப்பு_அகராதி_வகை, மொழிபெயர்ப்பு_நெடுவரிசை_அடையாளம் } from "@/குறியீட்டு.js";
...
describe("கிளிமூக்கு", async () => {
  ...
  describe("பரிந்துரைகள்", async () => {
    ...
    const பரிந்துரைகள் = new attente.AttendreRésultat<பிணையம்_மொழிபெயர்ப்பு_பரிந்துரை_வகை[]>();
    const செ_மறந்துவிடு: (() => Promise<void>)[] = [];
    ...
    before(async () => {
      ...
      const {fOublier: பரிந்துரைகளை_மறந்துவிடு} = await என்_கிளிமூக்கு.மொழிபெயர்ப்பு_பரிந்துரைகளை_கேள்ளு({
